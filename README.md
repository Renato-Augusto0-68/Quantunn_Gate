...
### Warning: if running on WSL, not by Linux, Pygame and OpenCv might not work the way they were suposed to, due to limitations of the librarys themselfs! 
#### But, for WSL the correction is in the document : For [WSL users](WSL-README.md)
...
# How to Play the Game:
  ...
  ## Lastly, to run the game:
   ### first, enter in the correct bin:
...
## Linux/Windows:
  Used as the OS for the compilation/memory acess and also compilation terminal and commands

# 🧠 Technical Differentiators
### Unlike simple text-based RPGs, the Quantum Gate is focused on:
